...
urlpatterns = [
    ...
    path('get-started', views.NewUser.as_view(), name='new_user'),
    path('get-started/done', views.NewUserSuccess.as_view(), name='new_user_success'),
    ...
    path('area-<int:area_pk>/log-<int:log_pk>/daily/<int:year>-<int:month>-<int:day>/acknowledge', views.Acknowledge.as_view(), name='acknowledge_daily'),
