...
class Log(models.Model):
    ...
    unit_lead_acknowledgement_fields = models.ManyToManyField(Field, blank=True, related_name='unit_lead_acknowledgement_fields')
    superintendent_acknowledgement_fields = models.ManyToManyField(Field, blank=True, related_name='superintendent_acknowledgement_fields')
    engineering_acknowledgement_fields = models.ManyToManyField(Field, blank=True, related_name='engineering_acknowledgement_fields')
    new_shift_acknowledgement_fields = models.ManyToManyField(Field, blank=True, related_name='new_shift_acknowledgement_fields')
